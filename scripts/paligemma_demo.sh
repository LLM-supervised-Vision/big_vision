...
python /home/austinwang/austin_big_vision/big_vision/trainers/proj/paligemma/run_llm.py \
    --ckpt gs://us-central2-storage/tensorflow_datasets/mllm_ckpts/paligemma/gemma2b-partial_frozen99-0.01-drop0.0-gap-vocab256128_b16-F_contrastive_bs16k_s3b_lr1e-3_wd1e-4_bf16_09-03_2131/checkpoint.bv-000014000-tmp/:llm
