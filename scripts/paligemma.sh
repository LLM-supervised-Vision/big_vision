...
python -m big_vision.trainers.proj.paligemma.train \
    --config big_vision/configs/proj/paligemma/paligemma_unified_configs.py:dataset_name='cambrian_dataset/10M:1.0.0',epoch=10.0,debug=True,debug_tiny_model=False \
