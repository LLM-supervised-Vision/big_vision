...
python -m big_vision.trainers.proj.coca.coca \
    --config big_vision/configs/proj/coca/coca_replication.py:batch_size=8192,warmup_ratio=0.02,lr=1e-3,dtype='bfloat16',dec_lyr=3,eval_only=False,debug=False \
