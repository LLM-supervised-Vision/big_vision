...
python -m big_vision.trainers.proj.coca.coca \
    --config big_vision/configs/proj/coca/coca_replication.py:batch_size=8192,warmup_ratio=0.02,lr=1e-3,dtype='bfloat16',dec_lyr=6,masked_pred_prob=0.00,scan=True,eval_only=False,debug=True \
