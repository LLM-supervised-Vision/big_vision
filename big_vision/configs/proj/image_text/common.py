...
inits = {
    ...
    'bert_base': ('base', '/mnt/vlm-pd/ckpts/bert/uncased_L-12_H-768_A-12/'),
    ...
    'B/16': ('B/16', '/mnt/vlm-pd/ckpts/augreg/B_16-i21k-300ep-lr_0.001-aug_medium1-wd_0.1-do_0.0-sd_0.0.npz'),
