...
def get_config(arg=None):
  c = bvcc.parse_arg(
    arg, res=224,
    objective='contrastive', loss_fn='softmax', training_mode='pretrain',
    dataset_name='laion400m/images', caption_key='caption',
    ...
    drop_path_rate=0.0, lr=1e-3, wd=1e-4, batch_size=16384, total_epochs=-1, total_samples=-1.0, dtype='float32',
    debug=False,
	)
  ...
  c.model_init = {'img': img_backbone, 'llm': llm_backbone}
